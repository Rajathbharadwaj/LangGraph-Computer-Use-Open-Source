...
Steps:
1. Call like_post with the post identifier (author or content)
2. Immediately call comment_on_post with the same post identifier and a thoughtful comment
...
NOTE: The comment_on_post tool AUTOMATICALLY generates comments in the user's writing style.""",
            "tools": [tool_dict["like_post"], tool_dict["comment_on_post"]]
        },
